...
@Injectable()
export class TrackRemoveTwitterProfileCommand extends TrackRemoveBaseCommand {
  private readonly logger = baseLogger.child({ context: TrackRemoveTwitterProfileCommand.name })
